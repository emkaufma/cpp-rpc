...
class StubClient : public jsonrpc::Client
{
    public:
        ...
        bool add(const Json::Value& Title) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["Title"] = Title;
        ...
        void toJsonFile(const std::string& param1) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p.append(param1);
            this->CallNotification("toJsonFile",p);
        }
        void loadFromJsonFile(const std::string& param1) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p.append(param1);
            this->CallNotification("loadFromJsonFile",p);
        }
